              ...
              <form action="/medicos" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="row form-group">
                        ...
                        <input class="col-3 form-control ml-2" name="mes" type="text" maxlength="2" placeholder="Mes">
                        <input class="col-4 form-control ml-2" name="ano" type="text" maxlength="4" placeholder="Año">
                    </div>
                </div>
                <div class="form-group">
